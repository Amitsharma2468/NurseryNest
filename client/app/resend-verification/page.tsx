...
export default function ResendVerificationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_APP_BACKEND_URL}/api/auth/resend-verification`, {
        method: "POST",
        headers: {
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-green-200 shadow-lg">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl text-center text-green-800">Email Verification</CardTitle>
